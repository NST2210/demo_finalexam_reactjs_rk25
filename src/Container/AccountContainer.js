...
function AccountContainer(props) {
  ...
  // Hàm callback xử lý search Account
  let onHandleSearch = (id) => {
    dispatchRedux(actionSearchAccountAPI(id));
  };
  ...
  return (
    <Container>
      <h1>Manangement Account</h1>
      <SearchForm onHandleSearch={onHandleSearch}></SearchForm>
      {/* Nút thêm mới */}
      ...
      {/* Form kết quả */}
      <ResultForm onHandleDelete={onHandleDelete} onHandleEdit={onHandleEdit} onHandleSearch={onHandleSearch}/>
    </Container>
  );
}
